...
const filename = `trading_chart_${Date.now()}.jpg`;
...
const uploadResponse = await fetch(`http://localhost:3000/api/media/channels/f2d40929-878c-4494-8c21-d7609acea4e7/upload-media`, {
  method: 'POST',
  body: formData
});
